...
#plot(trainingSplit$excluded$monomerRepeats, trainingSplit$excluded$twomerRepeats, col="black", xlim=c(50,225), ylim=c(0,100))
#points(trainingSplit$normal$monomerRepeats, trainingSplit$normal$twomerRepeats, col=alpha("blue", 0.4))
#points(trainingSmoteSplit$excluded$monomerRepeats, trainingSmoteSplit$excluded$twomerRepeats, col=alpha("red", 0.3), pch = 4)
#dev.off()
