...
echo "treatment, sampleId, SSD, NRF, FRiP, FractionLongPromoter20000to2000, FractionPromoter2000to500, FractionPromoter500, FractionAllTranscripts, FractionAllIntrons" > chipQCResults.csv
